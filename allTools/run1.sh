...
#生成肿瘤样本sim s1初代克隆
./tumsim -r 0.0008 -X 0 -D 0 -B 0.333330 -b 0 -A 0 -p 0 -n 0 -l 0 -I inspos.txt chr1.fa nor.sim nor_AB.idx s11.sim &&
...
#生成肿瘤样本sim s2为s1的子克隆
./tumsim -r 0.0008 -X 0 -D 0 -B 0.333330 -b 0 -A 0 -p 0 -n 0 -l 0 -I inspos.txt chr1.fa s1.sim s1_AB.idx s22.sim &&
#generate diff_S1_S2
...
#生成肿瘤样本sim s3为s2的子克隆
./tumsim -r 0.0004 -X 0 -D 0 -B 0.333330 -b 0 -A 0 -p 0 -n 0 -l 0 -I inspos.txt chr1.fa s2.sim s2_AB.idx s33.sim &&
#generate diff_S2_S3
...
#生成肿瘤样本sim s4为s3的子克隆
./tumsim -r 0.0002 -X 0 -D 0 -B 0.333330 -b 0 -A 0 -p 0 -n 0 -l 0 -I inspos.txt chr1.fa s3.sim s3_AB.idx s44.sim &&
#generate diff_S3_S4
