...
5。截取一段写入inspos3.txt
'''
#python genCNV4.py diff_s2_s3.txt inspos1.txt inspos2.txt inspos3.txt s33.sim chr1.fa
import sys
import random
assert len(sys.argv) == 7
file1,file2,file3, file4,simFile,refFile = sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5],sys.argv[6]
...
def getDiff_s2_s3(file1):
	...
	return data
def getInsertPos(file2,file3,file4):
	pos = []
...
def getInsposTxt(ref,candidateSnp):
	...
	f = open("inspos4.txt",'w')
	f.write(str1)



snpPos=getDiff_s2_s3(file1)
CNVPos=getInsertPos(file2,file3,file4)
